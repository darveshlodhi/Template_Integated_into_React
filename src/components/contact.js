    					...
    					<div class="row">
    						...
    						<div class="col-sm-6 col-lg-3">
    							<div class="social_icon">
    								<ul>
    									<li><img src="images/fb-icon.png"alt="image5"/></li>
    									<li><img src="images/twitter-icon.png"alt="image5"/></li>
    									<li><img src="images/in-icon.png"alt="image5"/></li>
    									<li><img src="images/instagram-icon.png " alt="image5"/></li>
    								</ul>
    							</div>
    						</div>
    					</div>
